...
def main(argv=[]):
    ...
    try:
        opts, args = getopt.getopt(argv,"hq:p:u:o:e:a:t",["qtable=", "ptable=", "ufile=","ofile=","epsilon=","aggregate_column=", "test_id="])
    except getopt.GetoptError:
        print('explanation.py -q <query_result_table> -p <pattern_table> -u <user_question_file> -o <outputfile> -e <epsilon> -a <aggregate_column> -t <test_id>')
        sys.exit(2)
    for opt, arg in opts:
        if opt == '-h':
            print('explanation.py -q <query_result_table> -p <pattern_table> -u <user_question_file> -o <outputfile> -e <epsilon> -a <aggregate_column> -t <test_id>')
