...
ax.set_xlabel('#Attributes in User Question', fontsize=22)
...
ax.legend(prop={'size': 24},labels=['ExplGen-Naive', 'ExplGen-Opt'],loc=2,borderpad=0,labelspacing=0,handlelength=1,handletextpad=0.2,
              columnspacing=0.5)
